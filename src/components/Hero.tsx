...
const Hero = () => {
  return (
    <section id="home" className="relative min-h-screen flex items-center pt-20 overflow-hidden">
      <div className="absolute inset-0 bg-gradient-to-br from-purple-600 to-blue-500 opacity-90 dark:opacity-80 z-0"></div>
      
      {/* Wave background effect */}
      <div className="absolute inset-0 z-0 opacity-20">
        {/* This would be replaced with an actual SVG wave pattern */}
        <div className="w-full h-full bg-[url('/wave-bg.svg')] bg-repeat"></div>
      </div>
      ...
      <div className="container-custom relative z-10 flex flex-col md:flex-row items-center justify-between gap-10">
        ...
        >
          ...
          <p className="text-lg opacity-90 mb-8 max-w-lg">
            ...
            technologies to create solutions that make an impact.
          </p>
          <div className="flex flex-wrap gap-4">
            ...
            <button className="btn-outline bg-white/10">
              Download Resume
          ...
          <div className="flex mt-10 space-x-4">
            ...
            <a href="https://medium.com" target="_blank" rel="noopener noreferrer" className="text-white hover:text-purple-300 transition-colors">
